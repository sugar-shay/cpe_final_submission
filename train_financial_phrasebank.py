...
def main():
    ...
    model = Lit_SequenceClassification(model_checkpoint, save_fp = 'best_phrasebank_model')
    ...
    #Uncomment  below if you you'd like to later plot train/val loss
    '''
    ...
    model = Lit_SequenceClassification('best_phrasebank_model')
    preds, ground_truths = model_testing(model, test_dataset)
